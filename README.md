...
- Grammar Lab teaches 26 core New HSK 1, 2, and 3 patterns with concise explanations, spoken examples, contextual multiple-choice checks, keyboard controls, focused mistake retries, and separate mastery history.
- Timed HSK 3.0 mock exams provide original Level 1, 2, and 3 written papers with the official section counts and time limits, one-play listening prompts, autosaved progress, question navigation, review flags, section scores, and persistent History records. Exam Coach adds part-level diagnostics, missed-answer guidance, personal-best comparisons, and direct handoffs into targeted practice.
